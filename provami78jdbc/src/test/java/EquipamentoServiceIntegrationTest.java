...
public class EquipamentoServiceIntegrationTest {
    ...
    private static final String CREATE_EQUIPAMENTO = """
            CREATE TABLE Equipamento (
              ...
              CONSTRAINT fk_equipamento_fornecedor
    ...
    static void setupGlobal() throws Exception {
        try (Connection conn = Conexao.conectar();
            ...
            stmt.execute("DROP TABLE IF EXISTS equipamento CASCADE");
            stmt.execute("DROP TABLE IF EXISTS fornecedor CASCADE");
    ...
    void setup() throws Exception {
        ...
        try (Connection conn = Conexao.conectar();
            ...
            stmt.execute("TRUNCATE TABLE equipamento, fornecedor RESTART IDENTITY CASCADE");
        }
    }
    ...
    void deveCadastrarEquipamento() throws SQLException {
        ...
        try (Connection conn = Conexao.conectar();
             PreparedStatement stmt = conn.prepareStatement(
                     "SELECT nome, fornecedor_id FROM equipamento WHERE id = ?")) {

            stmt.setInt(1, salvo.getId());
    ...
    @Test
    @DisplayName("Deve retornar Exception quando id equipamento não existe")
    ...
    void deveAtualizarEquipamento() throws SQLException {
        ...
        try (Connection conn = Conexao.conectar();
             PreparedStatement stmt = conn.prepareStatement(
                     "SELECT nome, numero_serie FROM equipamento WHERE id = ?")) {
    ...
    void deveDeletarEquipamento() throws SQLException {
        ...
        try (Connection conn = Conexao.conectar();
             PreparedStatement stmt = conn.prepareStatement(
                     "SELECT count(*) FROM equipamento WHERE id = ?")) {
